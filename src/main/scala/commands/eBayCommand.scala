...
case class PassRemove(auction: String, seller: ActorRef[SellerCommand]) extends eBayCommand
...
case class SuccessfullyFinished(auction: ActorRef[AuctionCommand]) extends eBayCommand